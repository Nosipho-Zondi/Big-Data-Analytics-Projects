-- Proffessor Fikeni - Governance Risk Model
...
-- Checking how bad the nulls are
SELECT COUNT(*) FROM suspensions WHERE employee_id IS NULL OR days_calc IS NULL;
SELECT COUNT(*) FROM employees WHERE vetting_status IS NULL OR dept IS NULL;
